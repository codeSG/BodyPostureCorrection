...
static void sendMessage(IOTHUB_CLIENT_LL_HANDLE iotHubClientHandle, char *buffer, bool messageSuccess)
{
    ...
    else
    {
        ...
        Map_Add(properties, "messageSuccess", messageSuccess ? "true" : "false");
